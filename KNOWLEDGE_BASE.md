...
External names mentioned by the brief and **not** fetched while writing this file: OpenAerialMap, Riseholme, UOPNOA, DroneWaste, SAM, YOLO. Add a source row when one of them is actually opened.
